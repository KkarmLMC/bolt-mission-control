...
const STATUS = {
  pending:  { label: 'Pending Review', bg: 'var(--state-warning-soft)', color: 'var(--state-warning-text)' },
  approved: { label: 'Approved',       bg: 'var(--state-success-soft)', color: 'var(--state-success-text)' },
  rejected: { label: 'Rejected',       bg: 'var(--state-error-soft)', color: 'var(--state-error-text)' } }
